  ...
  return (
    <>
      <main className="w-full min-h-screen grid grid-cols-1 lg:grid-cols-2 relative bg-background overflow-hidden items-stretch pt-24 pb-12 lg:py-0">
        ...
        <div className="px-8 md:px-12 lg:px-12 xl:px-20 flex flex-col justify-center relative z-10 lg:border-r border-border/30 h-full py-12 lg:py-32">
        ...
        <div className="px-8 md:px-12 lg:px-8 xl:px-16 flex flex-col justify-center bg-card/10 lg:bg-card/5 backdrop-blur-3xl lg:backdrop-blur-none relative z-10 h-full py-12 lg:py-32">
          <motion.div
            initial={{ opacity: 0, x: 30 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="w-full md:min-w-[540px] max-w-2xl mx-auto lg:mx-0 bg-background/80 dark:bg-zinc-900/80 p-8 md:p-10 xl:p-14 rounded-[2.5rem] border border-border/80 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] backdrop-blur-2xl"
          >
