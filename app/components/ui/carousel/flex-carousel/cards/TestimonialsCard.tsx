...
function RenderDescription({
  ...
  if (container.order === centerOrder || !truncatedDescription) {
        ...
        {!showFullDescription ? (
          <>
            <motion.p
              ...
              className="max-w-full text-foreground dark:text-slate-50 text-md md:text-[1.6vw] lg:text-[1.4vw] 2xl:text-[1vw] font-normal tracking-tight"
            >
    ...
    return (
      <>
        <p className="max-w-full text-foreground dark:text-slate-50  text-md md:text-[1.6vw] lg:text-[1.4vw] 2xl:text-[1vw] font-normal tracking-tight">
          {truncatedDescription}...
        </p>
        <ButtonMoreOrLess toggleDescription={toggleDescription} more />
      </>
    ...
    <>
      {container.order && container.icon && (
        ...
        >
          ...
          <h5 className="text-muted-foreground text-sm md:text-[1.4vw] lg:text-[1.2vw] 2xl:text-[0.8vw] font-medium">
            {container.position}
          </h5>
          <RenderDescription
            container={container}
