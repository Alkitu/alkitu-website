...
function CategoryCardAutoMove({ category, className, index, wordIndex }) {
  ...
  return (
    ...
    >
      ...
      ></div>
      <div
        className={`  w-[98%] mx-auto relative  bg-background  rounded-3xl flex-col content-center items-center justify-center   ${
      ...
      >
        ...
        />
        <p className="text-center h-full text-xl font-black uppercase m-auto w-full text-foreground">
...
export default CategoryCardAutoMove;
