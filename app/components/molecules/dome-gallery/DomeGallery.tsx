  ...
  const openItemFromElement = (el: HTMLElement) => {
    ...
    if (wantsResize) {
      ...
      const fitToNaturalRatio = () => {
        ...
        if (targetH > frameR.height) {
          targetH = frameR.height;
          targetW = targetH * ratio;
        }

        if (Math.abs(targetW - frameR.width) < 2 && Math.abs(targetH - frameR.height) < 2) return;
      ...
      const onExpandEnd = (ev: TransitionEvent) => {
        ...
        if (img.naturalWidth && img.naturalHeight) {
          ...
          img.addEventListener('load', fitToNaturalRatio, { once: true });
        }
      };
              ...
              >
                ...
                >
                  <img
                    ...
                    alt={it.alt}
                    onError={(e) => {
                      const tile = (e.target as HTMLElement).closest('.item') as HTMLElement;
