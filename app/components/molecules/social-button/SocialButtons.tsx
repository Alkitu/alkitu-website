    ...
    <>
      ...
      <div className="flex flex-wrap justify-start gap-7 mt-4">
        ...
        <a
          ...
          } hover:fill-[#1d9bf0] transition-all w-12 h-12 bg-zinc-300 rounded-full flex items-center justify-center shadow-xl cursor-pointer`}
        >
          <svg
            width="24"
            height="20"
        ...
        <a
          ...
          } hover:fill-[#229ED9] transition-all w-12 h-12 bg-zinc-300 rounded-full flex items-center justify-center shadow-xl cursor-pointer`}
        >
          <svg
            width="24"
            height="20"
