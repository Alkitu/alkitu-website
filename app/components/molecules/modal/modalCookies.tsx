...
export default function ModalCookies({ modalOpen, handleClose }: ModalCookiesProps) {
...
function ModalContent({ translations, handleClose, modalOpen }: ModalContentProps) {
