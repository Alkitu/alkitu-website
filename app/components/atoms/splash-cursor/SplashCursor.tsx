...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    // --- Event handlers (scoped to container for contained effect) ---
    ...
    const onMouseMove = (e: MouseEvent) => {
      ...
      const posX = scaleByPixelRatio(e.clientX - rect.left);
      const posY = scaleByPixelRatio(e.clientY - rect.top);
      const color = pointer.down ? pointer.color : generateColor();
    ...
    const onFirstMouseMove = (e: MouseEvent) => {
      ...
      updateFrame();
      updatePointerMoveData(pointer, posX, posY, color);
      container.removeEventListener('mousemove', onFirstMouseMove);
    };
    ...
    const onFirstTouchStart = (e: TouchEvent) => {
      ...
      container.removeEventListener('touchstart', onFirstTouchStart);
    };
    ...
    container.addEventListener('mousemove', onFirstMouseMove);
    container.addEventListener('mousemove', onMouseMove);
    container.addEventListener('touchstart', onFirstTouchStart);
