...
import { Symbol } from "@/app/components/atomic/atoms/symbol";

function PassionFloatingElements() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        variants={child}
        className="hidden md:block absolute md:bottom-[12vw] md:-right-[2vw] lg:bottom-[12vw] lg:-right-[2vw]"
      >
      ...
      <motion.div
        variants={child}
        className="absolute bottom-[55vw] right-[0vw] md:bottom-[18vw] md:-right-[5vw] lg:bottom-[15vw] lg:-right-[7vw]  z-30"
      >
      ...
      <motion.div
        variants={child}
        className="absolute  bottom-[55vw] left-[8vw]  md:bottom-[21.5vw] md:-left-[2.5vw] lg:bottom-[7.25vw] lg:-left-[3vw] z-30"
      >
      ...
      <motion.div
        variants={child}
        className="hidden md:block absolute md:bottom-[20vw] md:left-[5.5vw] lg:bottom-[12vw] lg:left-[2vw] "
      >
      ...
      <motion.div
        variants={child}
        className=" md:block absolute -left-[5vw] top-[30vw] md:-top-[2.5vw] md:left-[5vw] lg:-top-[1.5vw] lg:left-[1vw] z-30"
      >
      ...
      <motion.div
        variants={child}
        className="hidden md:block absolute md:top-[2vw] md:left-[9vw] lg:top-[2vw] lg:left-[5vw] -z-40"
      >
...
export default PassionFloatingElements;
