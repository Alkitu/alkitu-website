import HeroFloatingElements from "@/app/components/atomic/organisms/hero-section/HeroFloatingElements";
import HeroPictureTriangle from "@/app/components/atomic/organisms/hero-section/HeroPictureTriangle";
