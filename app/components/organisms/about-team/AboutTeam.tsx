        ...
        <div className="flex flex-wrap justify-center gap-10">
          {members.map((member, index) => (
            <motion.div
              ...
              className="flex flex-col items-center group w-full max-w-[300px]"
            >
              ...
              <p className="text-primary font-medium text-[min(1rem,3.16vw)] lg:text-[0.9vw] uppercase tracking-wide text-center">{member.role}</p>
            </motion.div>
          ))}
        </div>
      </div>
