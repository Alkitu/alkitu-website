...
/*  Card atom                                                           */
/* ------------------------------------------------------------------ */
export const Card = forwardRef<HTMLDivElement, CardProps>(({ customClass, className, children, style, ...rest }, ref) => (
    <>
        <style>{`
            .cs-card {
                position: absolute;
        ...
        <div
            ref={ref}
            className={`cs-card${customClass ? ` ${customClass}` : ''}${className ? ` ${className}` : ''}`}
            style={style}
            {...rest}
        >
            {children}
    ...
    return (
        <>
            <style>{`
                ...
                @media (max-width: 768px) { .cs-container { transform: scale(0.75) translate(25%, 25%); } }
                @media (max-width: 480px) { .cs-container { transform: scale(0.55) translate(25%, 25%); } }
            `}</style>
