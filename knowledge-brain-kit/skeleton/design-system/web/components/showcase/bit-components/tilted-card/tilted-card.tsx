...
export function TiltedCard({
    ...
    className
}: TiltedCardProps & { className?: string }) {
    ...
    return (
        ...
        >
            ...
            {showTooltip && (
                <motion.figcaption
                    className="pointer-events-none absolute left-0 top-0 rounded-md bg-popover px-2.5 py-1 text-[10px] text-popover-foreground shadow-sm opacity-0 z-[3] hidden sm:block"
                    style={{
                        x,
                        y,
                        opacity,
