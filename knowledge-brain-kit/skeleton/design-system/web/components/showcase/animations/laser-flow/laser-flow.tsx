...
export const LaserFlow: React.FC<LaserFlowProps> = ({
    ...
    useEffect(() => {
        ...
        const uniforms: Record<string, { value: unknown }> = {
            ...
            uFogScale: { value: fogScale }, uWSpeed: { value: wispSpeed }, uWIntensity: { value: wispIntensity }, uFlowStrength: { value: flowStrength },
            uDecay: { value: decay }, uFalloffStart: { value: falloffStart }, uFogFallSpeed: { value: fogFallSpeed },
        ...
        let prevTime = 0; let fade = 0;
        const mouseTarget = new THREE.Vector2(0, 0);
        const mouseSmooth = new THREE.Vector2(0, 0);

        const setSizeNow = () => {
            const w = mount.clientWidth || 1; const h = mount.clientHeight || 1; const pr = currentDprRef.current;
        ...
        const updateMouse = (clientX: number, clientY: number) => {
            ...
            const ratio = currentDprRef.current; const hb = rect.height * ratio;
        ...
        const animate = () => {
            ...
            const t = clock.getElapsedTime(); const dt = Math.max(0, t - prevTime); prevTime = t;
            (uniforms.iTime as { value: number }).value = t;
            const cdt = Math.min(0.033, Math.max(0.001, dt));
            (uniforms.uFlowTime.value as number);
