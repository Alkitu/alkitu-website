...
export const MetaBalls: React.FC<MetaBallsProps> = ({
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      // Update canvas style directly to prevent size issues
    ...
    // We need a ResizeObserver to handle element size changes properly (e.g. inside flex/grid)
  ...
  return <div ref={containerRef} className={cn("w-full h-full relative overflow-hidden", className)} />;
};
