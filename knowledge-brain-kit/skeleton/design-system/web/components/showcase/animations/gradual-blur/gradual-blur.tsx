...
const DEFAULT_CONFIG: Partial<GradualBlurProps> = {
    ...
    zIndex: 1000, animated: false, duration: '0.3s', easing: 'ease-out', opacity: 1,
...
const useResponsiveDimension = (responsive: boolean | undefined, config: Partial<GradualBlurProps>, key: keyof GradualBlurProps) => {
...
export { GradualBlur, GradualBlurMemo };
