...
export default function Threads({
    ...
    useEffect(() => {
        ...
        function resize() {
            ...
            (program.uniforms.iResolution.value as Color).r = container.clientWidth;
            (program.uniforms.iResolution.value as Color).g = container.clientHeight;
            (program.uniforms.iResolution.value as Color).b = container.clientWidth / container.clientHeight;
        }
    ...
    return <div ref={containerRef} className={cn("threads-container", className)} style={style} {...rest} />;
}
